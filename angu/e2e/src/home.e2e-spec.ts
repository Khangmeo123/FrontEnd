...
describe('home page test select boxes, radios check, date picker by sendkey', () => {
    ...
    it('form home should be valid', () => {
        (page.getOption1().click() || page.getOption2().click() || page.getOption3().click || page.getOption4().click())
            && (page.getRadio1CheckBox().click() || page.getRadio2CheckBox().click() || page.getRadio3CheckBox().click())
